...
- сохранение полного дампа HTTP-ответа в виде файлов `*.response` в локальный каталог `.response/` и добавление под выполненным запросом history-комментариев вида `# <> ./.response/...`
